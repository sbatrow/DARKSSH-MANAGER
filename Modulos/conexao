...
[[ $(awk -F" " '{print $2}' /usr/lib/licence) == "@CRAZY_VPN" ]] && {
	...
	inst_sqd() {
		if netstat -nltp | grep 'squid' 1>/dev/null 2>/dev/null; then
			...
			echo ""
			echo -ne "\033[1;32mREALLY WISH TO REMOVE SQUID \033[1;31m? \033[1;33m[s/n]:\033[1;37m "
			read resp
			[[ "$resp" = 's' ]] && {
			...
			echo -e "\n\033[1;33mWHICH PORTS DO YOU WANT TO USE IN THE SQUID \033[1;31m?"
			echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mSET THE PORTS IN SEQUENCE \033[1;33mEX: \033[1;37m80 8080"
			echo ""
			...
			[[ $(grep -wc '14' /etc/issue.net) != '0' ]] || [[ $(grep -wc '8' /etc/issue.net) != '0' ]] && {
				...
				read -p "$(echo -e "\033[1;32mREPORT AN OPTION \033[1;37m: ")" -e -i 1 opc
				[[ -z "$opc" ]] && {
					echo -e "\n\033[1;31mOption invalid!"
					sleep 2
					fun_conexao
				}
				[[ "$opc" != '1' ]] && {
			...
			if [[ -d "/etc/squid/" ]]; then
				...
				echo -e "\n\033[1;33m[\033[1;31mERRO\033[1;33m]\033[1;37m: \033[1;33mO CORRUPTED SQUID PROXY\033[0m"
				sleep 2
				fun_conexao
			fi
			cat <<-EOF >$var_pay
			...
			echo -e "\n\033[1;32mCONFIGURING SQUID PROXY\033[0m"
			echo ""
			fun_bar 'sqd_conf'
	...
	addpt_sqd() {
		...
		echo -ne "\033[1;32mWHICH PORTS YOU WANT TO ADD \033[1;33m?\033[1;37m "
		read pt
		[[ -z "$pt" ]] && {
			echo -e "\n\033[1;31mInvalid ports!"
			sleep 2
			clear
			fun_conexao
		}
		verif_ptrs $pt
		echo -e "\n\033[1;32mADDING PORTS TO SQUID!"
		echo ""
		sed -i "s/#Portas/#Portas\nhttp_port $pt/g" $var_sqd
		fun_bar 'sleep 2'
		echo -e "\n\033[1;32mRESTARTING SQUID!"
		echo ""
		fun_bar 'service squid restart' 'service squid3 restart'
		echo -e "\n\033[1;32mSUCCESSFULLY ADDED PORTS!"
		sleep 3
		clear
		fun_squid
	}
	...
	rempt_sqd() {
		echo -e "\E[41;1;37m          REMOVE SQUID PORTS       \E[0m"
		echo -e "\033[0;34m #BY:🔥⚡️⚡️ Sithum Batrow 🇱🇰 ⚡️⚡️🔥         \E[0m"
		...
		echo -ne "\033[1;32mWHICH PORTS YOU WISH TO REMOVE \033[1;33m?\033[1;37m "
		read pt
		[[ -z "$pt" ]] && {
			echo -e "\n\033[1;31mInvalid ports!"
			sleep 2
		...
		if grep -E "$pt" $var_sqd >/dev/null 2>&1; then
			...
			echo ""
			fun_bar 'service squid restart' 'service squid3 restart'
			echo -e "\n\033[1;32mPORTS SUCCESSFULLY REMOVED!"
			sleep 3.5s
			clear
			fun_squid
		else
			echo -e "\n\033[1;31mPORTS \033[1;32m$pt \033[1;31mNOT FOUND!"
			sleep 3.5s
			clear
			fun_squid
		fi
...
[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mADD PORTS \033[1;31m
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mREMOVE PORTS\033[1;31m
[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mCOME BACK\033[0m"
	...
	fun_drop() {
		if netstat -nltp | grep 'dropbear' 1>/dev/null 2>/dev/null; then
			clear
			[[ $(netstat -nltp | grep -c 'dropbear') != '0' ]] && dpbr=$(netstat -nplt | grep 'dropbear' | awk -F ":" {'print $4'} | xargs) || sqdp="\033[1;31mAVAILABLE"
			...
			echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mCHANGE DROPBEAR PORTS\033[0m"
			...
			if [[ "$resposta" = '1' ]]; then
				...
				echo ""
				echo -ne "\033[1;32mWHICH PORTS YOU WANT TO USE \033[1;33m?\033[1;37m "
				read pt
				echo ""
				verif_ptrs $pt
				var1=$(grep 'DROPBEAR_PORT=' /etc/default/dropbear | cut -d'=' -f2)
				echo -e "\033[1;32mCHANGING DOOR DROPBEAR!"
				...
				echo -e "\n\033[1;32mPORTS CHANGED SUCCESSFULLY!"
				sleep 3
				clear
				fun_conexao
			elif [[ "$resposta" = '3' ]]; then
				echo -e "\n\033[1;32mREMOVING DROPBEAR!\033[0m"
				echo ""
				fun_dropunistall() {
			...
			read resposta
			[[ "$resposta" = 's' ]] && {
				echo -e "\n\033[1;33mSET A PORTS TO DROPBEAR!\033[0m\n"
				echo -ne "\033[1;32mWHAT PORTS \033[1;33m?\033[1;37m "
				read porta
				[[ -z "$porta" ]] && {
					echo -e "\n\033[1;31mInvalid door!"
					sleep 3
					clear
					fun_conexao
				}
				...
				echo ""
				echo -e "\033[1;32mCONFIGURING DROPBEAR PORTS!\033[0m"
				echo ""
				fun_bar 'fun_ports'
				...
				echo -e "\n\033[1;32mINSTALLATION COMPLETED \033[1;33mPORTA: \033[1;37m$porta\033[0m"
	...
	inst_ssl() {
		if netstat -nltp | grep 'stunnel4' 1>/dev/null 2>/dev/null; then
			...
			echo ""
			echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mCHANGE SSL TUNNEL PORT\033[0m"
			...
			echo ""
			[[ "$resposta" = '1' ]] && {
				echo -ne "\033[1;32mWHICH DOOR YOU WANT TO USE \033[1;33m?\033[1;37m "
				read porta
				echo ""
				[[ -z "$porta" ]] && {
					echo ""
				...
				echo ""
				netstat -nltp | grep 'stunnel4' >/dev/null && echo -e "\033[1;32mPORT CHANGED SUCCESSFULLY!" || echo -e "\033[1;31mUNEXPECTED ERROR!"
				sleep 3.5s
				clear
				fun_conexao
			}
			...
			[[ "$resposta" = 's' ]] && {
				...
				echo ""
				read -p "$(echo -e "\033[1;32mWHICH PORTS DO YOU WANT TO USE? \033[1;37m")" -e -i 443 porta
				[[ -z "$porta" ]] && {
					echo ""
					echo -e "\033[1;31mInvalid port!"
					sleep 3
				...
				echo -e "\n\033[1;32mSSL TUNNEL SUCCESSFULLY INSTALLED!\033[1;31m PORTA: \033[1;33m$porta\033[0m"
				sleep 3
				clear
				fun_conexao
			} || {
	...
	fun_socks() {
		...
		if [[ "$resposta" = '1' ]]; then
			...
			if ps x | grep -w proxy.py | grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo -e "\033[1;31m[\033[1;36m10\033[1;31m]\033[1;33m ESM COLOR"
				echo ""
	...
	fun_conexao() {
		while true $x != "ok"; do
			...
			[[ "$(ps x | grep 'slow_dns' | grep -v 'grep'|wc -l)" != '0' ]] && {
			    echo -e "\033[1;32mSERVICE: \033[1;33mSLOWDNS \033[1;32mPORT: \033[1;37m$(sed -n 1p /etc/SSHPlus/dns/autodns | awk '{print $6}' | cut -d':' -f2)"
				sts8="\033[1;32m◉ "
			} || {
				sts8="\033[1;31m○ "
			}
